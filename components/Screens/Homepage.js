...
import { doc, setDoc, updateDoc, getDocs, collection, query, where } from 'firebase/firestore'; // Import Firestore functions
import Geolocation from 'react-native-geolocation-service'; // Import Geolocation
import { check, request, PERMISSIONS, RESULTS } from 'react-native-permissions'; // Import permissions functions
    ...
    if (Platform.OS === 'ios') {
      ...
      const result = await PermissionsAndroid.request(
        PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION,
        {
          ...
          message: 'We need your location to use the SOS feature.',
  ...
  const handleSOS = async () => {
    ...
    Geolocation.getCurrentPosition(
      ...
      (error) => {
        ...
        Alert.alert('Location Error', 'Error getting location. Please ensure location services are enabled.');
      },
